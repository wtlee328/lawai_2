-- Fix upsert_search_result function to properly handle added_to_doc_gen updates
-- This fixes the issue where COALESCE prevented null values from being saved
