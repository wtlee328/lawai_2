-- Drop existing case_2 table if it exists
...
CREATE INDEX case_2_embedding_hnsw_idx 
ON case_2 USING hnsw (embedding vector_cosine_ops);

-- Create additional indexes for better query performance
CREATE INDEX idx_case_2_case_id ON case_2(case_id);
CREATE INDEX idx_case_2_case_topic ON case_2(case_topic);
CREATE INDEX idx_case_2_case_date ON case_2(case_date);
