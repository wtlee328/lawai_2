-- Create simple, working multi-field search function
...
BEGIN
  ...
  IF query_content_embedding IS NOT NULL AND 
    ...
    SELECT 
      ...
      c.url,
      c.laws,
      (1 - (c.content_embedding <=> query_content_embedding)) as content_similarity,
      0.0 as dispute_similarity,
      0.0 as opinion_similarity,
      0.0 as result_similarity,
      (1 - (c.content_embedding <=> query_content_embedding)) as weighted_similarity
    FROM case_2 c
